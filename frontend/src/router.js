...
const routes = [
    ...
    {
        path: '/search', // la ruta base
        name: 'Search', // el nombre de la ruta
        component: () => import('./views/Search.vue') // el componente que se renderiza
        // meta: { analytics: true }
    },
    {
...
const router = createRouter({
    history: createWebHistory('/'), // usa el modo history para evitar el hash (#) en la URL
    routes,
